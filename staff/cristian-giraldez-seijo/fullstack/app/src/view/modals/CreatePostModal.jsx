/**
 * The CreatePostModal component is a form that allows users to create a new post with an image and
 * text.
 * @returns The CreatePostModal component is being returned.
 */
