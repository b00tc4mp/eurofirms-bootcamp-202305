    ...
    <div className="home-view">
        ...
        <main className="home-main">
            <section className="home-posts">
                <article>
                    <img className="home-post-image" src="https://2.bp.blogspot.com/-OBGl0OzZ6iE/T24HFSGjGCI/AAAAAAAAJyA/moLbzk7n0v8/s1600/CalicoRulez.jpg" alt="Calico Electrónico"></img>
