...
function CreateMeetupModal(props){
    ...
    >
        <div className="bg-white opacity-100 pt-10">
            ...
            <form className="bg-white px-20 pt-10" onSubmit={handleSubmit} //flex flex-col items-center justify-center gap-7
            >
                <label className="mt-6" htmlFor="image">Image</label>
                <input className="rounded-md bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-md p-2.5 dark:bg-[#d9d9d9] dark:border-gray-600 dark:placeholder-gray-400 dark:text-[#494949] dark:focus:ring-blue-500 dark:focus:border-blue-500 dg-" id="image" type="url"></input>
                ...
                <textarea className="rounded-md bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-[#d9d9d9] dark:border-gray-600 dark:placeholder-gray-400 dark:text-[#494949] dark:focus:ring-blue-500 dark:focus:border-blue-500" id="adress" type="text"></textarea>

                <label htmlFor="dateMeetup">Date meetup</label>
                <input className="rounded-md bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-[#d9d9d9] dark:border-gray-600 dark:placeholder-gray-400 dark:text-[#494949] dark:focus:ring-blue-500 dark:focus:border-blue-500" id="dateMeetup" type="date" />
                
                <button className="bg-[#2C2A2A] text-white px-4 py-2 text-sm text-center rounded-full my-2 hover:bg-[#707070]" type="submit">Create</button>
                <button className="bg-[#2C2A2A] text-white px-4 py-2 text-sm text-center rounded-full my-2 hover:bg-[#707070]" type="button" onClick={handleCancelClick}>Cancel</button>
            </form>
        </div>
    </div>
}
