    ...
    return <div className="bg-[rgba(0, 0, 0, 0.497)] fixed w-full h-full top-0 flex items-center justify-center">
        <div className="bg-white px-20 pt-10">
            ...
            >
                ...
                <input className="rounded-md bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-md p-2.5 dark:bg-[#d9d9d9] dark:border-gray-600 dark:placeholder-gray-400 dark:text-[#494949] dark:focus:ring-blue-500 dark:focus:border-blue-500" id="image" type="url"></input>
