...
export default function MessageChat() {
    ...
    return <section className="flex flex-col">
        <div className="flex justify-between items-center border-b-2 border-gray-400 py-1 px-2">
            ...
            <button onClick={handleBack} className="button bg-color4 text-white border-none rounded-xl px-3 py-1 ml-40 font-bold text-lg cursor-pointer transition duration-300 hover:bg-color3">Back</button>
        </div>
