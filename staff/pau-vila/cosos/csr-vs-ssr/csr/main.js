...
a.onclick = function (event) {
    ...
    const p = document.createElement('p')
    p.innerText = 'Client-side rendering allows developers to make their websites entirely rendered in the browser whit javaScript.Instead of having a different HTML page per route, a client-side rendered wevside creates each route dynamically directly in the browser.'
    document.body.appendChild(p)
